...
- (void)buildCell{
    ...
    self.model.newsTime = @"2016-03-20";
    ...
    titleLabel = [TGLabel initWithFrame:CGRectMake(titleLabelX, originY, titleLabelW, titleLabelH) text:self.model.newsTitle textColor:C_BLUE textFont:FONTSIZE12 textAlignment:NSTextAlignmentLeft superView:self.contentView];
    
    
    CGFloat bottomLabelY = titleLabel.y + titleLabel.height + gap;
    CGFloat bottomLabelW = 64;
    CGFloat bottomLabelH = 16;
    sourceLabel = [TGLabel initWithFrame:CGRectMake(titleLabel.x, bottomLabelY, bottomLabelW, bottomLabelH) text:self.model.newsSource textColor:C_BLACK textFont:FONTSIZE10 textAlignment:NSTextAlignmentLeft superView:self.contentView];
    
    CGFloat timeLabelX = DEVICE_W - L_R_EDGE - bottomLabelW;
    timeLabel = [TGLabel initWithFrame:CGRectMake(timeLabelX, bottomLabelY, bottomLabelW, bottomLabelH) text:self.model.newsTime textColor:C_BLACK textFont:FONTSIZE10 textAlignment:NSTextAlignmentRight superView:self.contentView];
